...
class RobotSimulatorTest < Minitest::Test
  ...
  def test_instruct_many_robots # rubocop:disable Metrics/MethodLength
    ...
    simulator.place(robot1, x: 11, y: 4, direction: :north)
    assert_raises Robot::AlreadyUsedCoordinates do
      simulator.evaluate(robot1, 'A')
    end
    assert_equal [11, 4],   robot1.coordinates
